 ...
 */
?>
<div id="maincontainer" class="loop">
...
<?php if ( post_password_required() ) : ?>
		<p class="loop-body">		<?php the_content(); ?>
<?php else : ?>
<?php
...
<?php /* Display navigation to next/previous pages when applicable */ ?>
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
		<span class="button">		<?php next_posts_link( __( '&larr; Older posts', 'twentyten' ) ); ?>
				<?php previous_posts_link( __( 'Newer posts &rarr;', 'twentyten' ) ); ?></span>
<?php endif; ?>
