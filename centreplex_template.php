    ...
    <div class="halfmilk">
      <h3>Related News Posts</h3>
        <div id="relevantPosts">
          <?php
          // The Query
          $args = array( 'numberposts' => 5, 'order'=> 'DESC', 'orderby' => 'post_date', 'tag' => 'centreplex' );
          query_posts( $args );
          // The Loop
...
<script type="text/javascript">    
  document.addEventListener('DOMContentLoaded', function() {
   ...
   function showInfo(data, tabletop) {
     ...
     var centreplex  = getProject(data, "Centreplex")
    ...
    function getProjectTotal(project) {
     ...
     var map = loadMap()
     centreplex.forEach(function (centreplex){
       displayAddress(map, centreplex)
     })
     ...
     var stats = ich.stats({
       ...
       "isCompleted":         isComplete(centreplex),
