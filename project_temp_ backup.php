...
<!--      $count = substr_count(file_get_contents($posttext), "\r"|"\n"|"\r\n");
      echo $count; was counting to see if it picked up on new lines in the text. nope -->
